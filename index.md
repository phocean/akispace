...
**現在満席のため小中学生の新しい生徒さんの募集は行なっておりません。高校生はIBもしくはTOEFLで曜日時間が合えば相談に応じます（1名のみ）。**

サイトをご覧いただきありがとうございます。こちらのレッスンでは「英語の分からない部文を分かるようにすること」をモットーとし、ただ問題を解いて解説するだけではなく、英文を読んで内容がじっくりと味わえる、そんな授業を行っています。そして、そのためにも文法や語彙といった基礎を大切にしています。実力がつけば、どんな資格試験も読むのが楽しくなりますよ。英検１級程度であれば毎回ほぼ満点を得点できるレベルですので、どんな資格試験でも詳しく徹底的に解説いたします。現在はフランス人と結婚しフランス・ブローニュ在住。フランス事業登録番号(SIRET47798964400026)を持つ家庭教師ですのでご安心ください。
